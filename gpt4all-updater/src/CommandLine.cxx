...
gpt4all::command::CommandLine::CommandLine()
{
    ...
    this->parser->addPositionalArgument("command", QCoreApplication::translate("main", "Gpt4All installation modification command, must be one of: 'update', 'downgrade', 'uninstall', 'modify'"));
}
...
gpt4all::command::CommandType gpt4all::command::CommandLine::command()
{
    ...
    switch(hash(command_arg.toStdString().c_str())) {
        ...
        default:
            // throw error, although the commnd line parser should have
            // caught this
    }
    return ret;
}

...
For `windows`: you need `WSL2` to run it. Make sure you have it. Clone repo there. ` \\wsl.localhost\Ubuntu\home\<YOUR_USERNAME>\gpt4all\ `-> put the model in the `\chat` directory.

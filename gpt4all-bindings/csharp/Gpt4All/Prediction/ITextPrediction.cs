...
public interface ITextPrediction
{
    ...
    Task<ITextPredictionResult> GetPredictionAsync(string text, CancellationToken cancellation = default);
    ...
    /// <returns>The prediction result generated by the model</returns>
    Task<ITextPredictionStreamingResult> GetStreamingPredictionAsync(string text, CancellationToken cancellationToken = default);
}

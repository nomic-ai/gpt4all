...
cp runtimes/osx/build/libgptj*.dylib  runtimes/osx/native/
cp runtimes/osx/build/libllama*.dylib  runtimes/osx/native/
cp runtimes/osx/build/libmpt*.dylib  runtimes/osx/native/
